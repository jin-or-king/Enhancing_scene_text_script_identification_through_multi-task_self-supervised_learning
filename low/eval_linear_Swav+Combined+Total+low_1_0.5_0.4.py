...
def main():
    ...
    restart_from_checkpoint(
        os.path.join(args.dump_path, "checkpoint_low34_all_75_1_0.5_0.4.pth.tar"),
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.rank == 0:
            ...
            torch.save(save_dict, os.path.join(args.dump_path, "checkpoint_low34_all_75_1_0.5_0.4.pth.tar"))
