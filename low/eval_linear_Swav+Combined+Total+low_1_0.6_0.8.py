...
def main():
    ...
    restart_from_checkpoint(
        os.path.join(args.dump_path, "checkpoint_low34_all_75_1_0.6_0.8.pth.tar"),
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.rank == 0:
            ...
            torch.save(save_dict, os.path.join(args.dump_path, "checkpoint_low34_all_75_1_0.6_0.8.pth.tar"))
...
def validate_network(val_loader, model, linear_classifier, classification=True):
    ...
    plot_confusion_matrix(conf_matrix, list(classes), "Confusion_Matrix_siw.jpeg", "(d)")
