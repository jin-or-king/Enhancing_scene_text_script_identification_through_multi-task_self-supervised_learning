...
import src.resnet50VFragmentRot_low as resnet_models
...
def main():
    ...
    restart_from_checkpoint(
        os.path.join(args.dump_path, "checkpoint_swav+totalRot+low_all.pth.tar"),
...
def train(train_loader, model, optimizer, epoch, lr_schedule, queue, low):
    ...
    for it, inputs in enumerate(train_loader):
        ...
        result, label_loc, q_loc, label_rot, q_rot = model(inputs, low=low)
