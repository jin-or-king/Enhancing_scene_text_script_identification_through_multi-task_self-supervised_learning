...
def main():
    ...
    restart_from_checkpoint(
        os.path.join(args.dump_path, "checkpoint_combined+total+low_all.pth.tar"),
...
def train(train_loader, model, optimizer, epoch, lr_schedule, queue, low):
    ...
    for it, inputs in enumerate(train_loader):
        ...
        result, label_combined, q_combined, label_rot, q_rot = model(inputs, low=low)
        ...
        for i, crop_id in enumerate(args.crops_for_assign):
            ...
            loss = loss * 0 + loss_combined * 0.4 + loss_rot * 0.25
